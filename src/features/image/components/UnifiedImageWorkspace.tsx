...
export function UnifiedImageWorkspace({
  ...
  return (
    <div className="relative flex h-full flex-1 flex-col overflow-hidden bg-[var(--surface-bg)]">
      ...
      <div
        className={`mx-auto flex w-full flex-1 min-h-0 flex-col ${step === 2 ? 'max-w-[1920px] p-3 sm:p-4 md:p-6' : 'max-w-5xl overflow-y-auto p-4 sm:p-6 md:p-8 custom-scrollbar'}`}
      >
        {/* Step 1: Upload Image */}
        {step === 1 && (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-[var(--text-secondary)]">
                      Leave blank to keep the uploaded file name.
                    </p>
                  </div>
                  <div>
                    <label className="mb-1 block text-xs font-semibold text-[var(--text-primary)]">
                ...
                {outputSettings.targetKB === 'custom' && (
                  <input
                    ...
                    onChange={(e) =>
                      setOutputSettings((s) => ({
                        ...s,
                        customKB: parseInt(e.target.value),
                      }))
                    }
              ...
              <div className="shrink-0 overflow-hidden rounded-xl border border-[var(--border-secondary)] bg-[var(--surface-primary)] p-4 shadow-sm">
                ...
                <div className="space-y-3 text-xs">
                  <div className="rounded-lg border border-[var(--border-secondary)] bg-[var(--surface-secondary)] p-2.5">
                    <p className="mb-1 text-[10px] font-bold uppercase tracking-wide text-blue-600 dark:text-blue-400">
                      Filename
                    </p>
