...
export function UnifiedMergeWorkspace({
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#f8f9fa] dark:bg-[#111] overflow-hidden relative">
      ...
      <div
        className={`mx-auto w-full flex flex-col flex-1 min-h-0 ${step === 2 ? 'p-4 md:p-6 max-w-[1920px]' : 'p-6 md:p-8 max-w-5xl overflow-y-auto custom-scrollbar'}`}
      >
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setNamingSettings((s: MergeNamingSettings) => ({
                          ...s,
