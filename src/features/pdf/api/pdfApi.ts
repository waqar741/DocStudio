export async function compressPdf(
  ...
  const res = await fetch(
    `${import.meta.env.VITE_API_URL || ''}/api/pdf/compress`,
    {
      method: 'POST',
      body: formData,
    },
...
export async function splitPdf(
  ...
  const res = await fetch(
    `${import.meta.env.VITE_API_URL || ''}/api/pdf/split`,
    {
      method: 'POST',
      body: formData,
    },
...
export async function rotatePdf(
  ...
  const res = await fetch(
    `${import.meta.env.VITE_API_URL || ''}/api/pdf/rotate`,
    {
      method: 'POST',
      body: formData,
    },
...
export async function rearrangePdf(
  ...
  const res = await fetch(
    `${import.meta.env.VITE_API_URL || ''}/api/pdf/rearrange`,
    {
      method: 'POST',
      body: formData,
    },
...
export async function deletePages(
  ...
  const res = await fetch(
    `${import.meta.env.VITE_API_URL || ''}/api/pdf/delete-pages`,
    {
      method: 'POST',
      body: formData,
    },
...
export async function extractPages(
  ...
  const res = await fetch(
    `${import.meta.env.VITE_API_URL || ''}/api/pdf/extract-pages`,
    {
      method: 'POST',
      body: formData,
    },
...
export async function addBlankPage(
  ...
  const res = await fetch(
    `${import.meta.env.VITE_API_URL || ''}/api/pdf/add-blank-page`,
    {
      method: 'POST',
      body: formData,
    },
