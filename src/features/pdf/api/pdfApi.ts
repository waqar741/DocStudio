export async function compressPdf(file: File, level: string, filename: string): Promise<Blob> {
  ...
  const res = await fetch(${import.meta.env.VITE_API_URL || ''}${import.meta.env.VITE_API_URL || ''}/api/pdf/compress, {
    method: 'POST',
    body: formData,
  })
...
export async function splitPdf(file: File, splitType: string, ranges: string, originalName: string): Promise<{ blob: Blob, filename: string }> {
  ...
  const res = await fetch(${import.meta.env.VITE_API_URL || ''}${import.meta.env.VITE_API_URL || ''}/api/pdf/split, {
    method: 'POST',
    body: formData,
  })
...
export async function rotatePdf(file: File, rotations: Record<number, number>, filename: string): Promise<Blob> {
  ...
  const res = await fetch(${import.meta.env.VITE_API_URL || ''}${import.meta.env.VITE_API_URL || ''}/api/pdf/rotate, {
    method: 'POST',
    body: formData,
  })
...
export async function rearrangePdf(file: File, order: number[], filename: string): Promise<Blob> {
  ...
  const res = await fetch(${import.meta.env.VITE_API_URL || ''}${import.meta.env.VITE_API_URL || ''}/api/pdf/rearrange, {
    method: 'POST',
    body: formData,
  })
...
export async function deletePages(file: File, toDelete: number[], filename: string): Promise<Blob> {
  ...
  const res = await fetch(${import.meta.env.VITE_API_URL || ''}${import.meta.env.VITE_API_URL || ''}/api/pdf/delete-pages, {
    method: 'POST',
    body: formData,
  })
...
export async function extractPages(file: File, ranges: string, originalName: string): Promise<{ blob: Blob, filename: string }> {
  ...
  const res = await fetch(${import.meta.env.VITE_API_URL || ''}${import.meta.env.VITE_API_URL || ''}/api/pdf/extract-pages, {
    method: 'POST',
    body: formData,
  })
...
export async function addBlankPage(file: File, position: number, size: string, filename: string): Promise<Blob> {
  ...
  const res = await fetch(${import.meta.env.VITE_API_URL || ''}${import.meta.env.VITE_API_URL || ''}/api/pdf/add-blank-page, {
    method: 'POST',
    body: formData,
  })
