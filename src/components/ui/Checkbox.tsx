...
export const Checkbox = forwardRef<HTMLInputElement, CheckboxProps>(
  (
    { className, label, description, error, id, required, disabled, ...props },
    ref,
  ) => {
    const generatedId =
      id ||
        ...
        <div className="flex h-5 items-center">
          <input
            ...
            className={cn(
              ...
              error &&
                'border-[var(--color-danger-500)] text-[var(--color-danger-600)] focus-visible:ring-[var(--color-danger-500)]',
            )}
            {...props}
          />
        </div>
