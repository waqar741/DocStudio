        ...
        <div
          ...
          className={cn(
            ...
            !disabled &&
              !isDragging &&
              !error &&
              'border-[var(--border-secondary)] bg-[var(--surface-primary)] hover:border-[var(--color-primary-400)] hover:bg-[var(--surface-hover)]',
            error &&
              'border-[var(--color-danger-500)] bg-[var(--color-danger-50)] dark:bg-[var(--color-danger-900)]',
          )}
          {...props}
        >
          <input
          ...
          <div
            className={cn(
              ...
              isDragging
                ? 'bg-[var(--color-primary-100)] dark:bg-[var(--color-primary-800)] text-[var(--color-primary-600)]'
                : 'bg-[var(--surface-secondary)] text-[var(--text-secondary)] group-hover:text-[var(--color-primary-600)]',
            )}
          >
