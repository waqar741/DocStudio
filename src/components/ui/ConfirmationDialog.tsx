  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} maxWidth="sm" hideCloseButton>
      <div className="flex flex-col items-center gap-4 py-6 text-center">
        <div
          className={`flex h-12 w-12 items-center justify-center rounded-full ${isDestructive ? 'bg-[var(--color-danger-50)] text-[var(--color-danger-600)] dark:bg-[var(--color-danger-900)]' : 'bg-[var(--color-warning-50)] text-[var(--color-warning-600)] dark:bg-[#331c00]'}`}
        >
