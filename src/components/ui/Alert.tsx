...
const alertVariants = cva('relative w-full rounded-lg border p-4 flex gap-3', {
  variants: {
    variant: {
      ...
      success:
        'bg-[var(--color-success-50)] border-[var(--color-success-200)] text-[var(--color-success-700)] dark:bg-[#062c1d] dark:border-[var(--color-success-800)] dark:text-[var(--color-success-100)]',
      warning:
        'bg-[var(--color-warning-50)] border-[var(--color-warning-200)] text-[var(--color-warning-700)] dark:bg-[#331c00] dark:border-[var(--color-warning-800)] dark:text-[var(--color-warning-100)]',
      danger:
        'bg-[var(--color-danger-50)] border-[var(--color-danger-200)] text-[var(--color-danger-700)] dark:bg-[#3a0a0a] dark:border-[var(--color-danger-800)] dark:text-[var(--color-danger-100)]',
    },
  },
  defaultVariants: {
    variant: 'default',
      ...
      >
        <Icon
          className={cn(
            ...
            iconColorClass[variant || 'default'],
          )}
        />
